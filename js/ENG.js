var ENG = {
    ...
    projects:{
        mNACTEC: "This was the first project, the client was mNACTEC a scientific museum from Terrassa, Barcelona. We created a web page related with the radio history.</br> <!--<a class=\"button btn btn-dark\" style=\"color: white;\">link radiocep</a>   </br>TEAMMATES --> </br> Lluis Perea </br> Oriol Barrera </br> Roger Baldomà",
        broggi: "This was the second project, the client was a college named \"Moises Broggi\" from Barcelona. We created a web where there is a medical system to manage incidencies. </br> </br></br> Eduard Gomà </br> Jordi Sanchez",
        mq: "" 
    },
    internship:{
        upc:{
